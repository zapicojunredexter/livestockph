...
<body style="background-color:#ddd;">
    ...
    <div class="d-flex clearfix container" style="min-height:1000px;width: 1000px;background-color:white; box-shadow: 12px 0 15px -4px #ccc, -12px 0 8px -4px #ccc;">
        
        <form id="filterForm" class="shop_sidebar_area" style="padding-top:20px;padding-right:50px;padding-left:50px;">
        ...
        <script>
            ...
            function filterTags(){
                ...
                window.location.href="view_products.php?"+filterData+"&minAgeRange="+ageRange[0]+"&maxAgeRange="+ageRange[1]+"&minPriceRange="+priceRange[0]+"&maxPriceRange="+priceRange[1];
            }
        </script>
                    ...
                    <div class="col-12">
                        <div class="product-topbar d-xl-flex align-items-end justify-content-between">
                            ...
                            <form id="sortForm" class="product-sorting d-flex">
                                ...
                                <div class="view-product d-flex align-items-center">
                                    <button type="button" onclick="clickSortProducts()" class="btn amado-btn">SORT</button>
                                </div>
                            </form>
                        </div>
                    </div>
                                    ...
                                    <div class="single-product-wrapper">
                                        ...
                                        <div class="product-description d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="product-meta-data">
                                                <div class="line"></div>
                                                <a style="padding-left: 10px;" href="../../containers/generic/registration.php?message=login required" class="product-price"><?php echo $product['CategoryDescription']." - ".$product['BreedDescription'];?></a>
                                                <a style="padding: 0px 20px 10px 20px;">
                                            ...
                                            <!-- Ratings & Cart -->
                                            <div class="ratings-cart text-right" style="margin-right:30px;">
                                                <div class="cart">
                                                    <a href="../../containers/generic/registration.php?message=login required" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="../../../assets/img/core-img/cart.png" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
